...
Помимо приведённых таблиц, были рассмотрены другие комбинации данных [[7]]. Наиболее ценные сведения:
- Датасет состоит прежде всего из наблюдений в сельской местности (2213, 86.08%) [[8]] с соответственно большой долей людей, занятых сельскохозяйственными работами (2032, 79.04%) [[9]]
- Хронологические рамки - 2009-2011 гг. Каждый год состоит из 12 месяцев [[18]]
- Наблюдения примерно равномерно разделелись по иходам попытки суицида (1315, 51.15% - выжили; 1256, 48.85% - умерли) [[10]]
- Видны сезонные флуктуации случаев. Во 2-м квартале фиксируется максимум, в 4-м - минимум [[11]]
- Все выжившие поытку суицида были госпитализированы. Из впоследствии умерших, госпитализировано лишь 238, 19% [[12]]. Исход попытки - главный предиктор госпитализации
- Смертельность попыток суицида стабильно растёт с увеличением возраста [[13]]
- Наиболее распространённые методы: употребление пестицида (1768, 68.77%), повешание (431, 16.76%), другие яды (146, 9.84%); наименее: прыгание (15, 0.58%), утопление (26, 1.01%), порезы (29, 1.13%) [[14]]
- Наиболее смертельные методы: утопление (26/26, 100%), повешание (419/431, 97%), прыгание (12/15, 80%); наименее: неопределённый яд (3/104, 3%), неопределённый (3/48, 6%), другой яд (15/146, 10%) [[15]]
