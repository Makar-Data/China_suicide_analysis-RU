...
- В чём разница между наблюдениями в городах и сеьской местности?
...
Для EDA преимуществественно применялись вариации трёх таблиц:
1. Количество и пропорция наблюдений по полю [[4]]
...
2. Количество и пропорция наблюдений по двум полям [[5]]
...
Итоги EDA:
- Хронологические рамки - 2009-2011 гг. Каждый год состоит из 12 месяцев [[]]
- Датасет состоит прежде всего из наблюдений в сельской местности (2213, 86.08%) [[8]] с соответственно большой долей людей, занятых сельскохозяйственными работами (2032, 79.04%)
- Наблюдения примерно равномерно разделелись по иходам попытки суицида (1315, 51.15% - выжили; 1256, 48.85% - умерли) [[]]
- Видны сезонные флуктуации случаев. Летом фиксируется максимум, зимой - минимум
- Все выжившие поытку суицида были госпитализированы. Из впоследствии умерших, госпитализировано лишь 238, 19% [[]]. Исход попытки - главный предиктор госпитализации
...
- Наиболее распространённые методы: употребление пестицида (1768, 68.77%), повешание (431, 16.76%), другие яды (146, 9.84%); наименее: прыгание (15, 0.58%), утопление (26, 1.01%), порезы (29, 1.13%) 
- Наиболее смертельные методы: утопление (26/26, 100%), повешание (419/431, 97%), прыгание (12/15, 80%); наименее: неопределённый яд (3/104, 3%), неопределённый (3/48, 6%), другой яд (15/146, 10%) [[]]
- Наиболее распространённые методы женщин: другой яд (66% наблюдений использования относится к женщинам), утопление (68%), пестицид (54%); мужчин: неопределённый (63% наблюдений использования относится к мужчинам), повешание (61%), порезы (52%) [[]]
- Хотя выживаемость после употребления пестицида относительно высока, смертельность попыток в сельской местности несколько выше, чем в городах (51%, 40%) [[]]
...
Для определения связи категорических значений был использован Хи-тест независимости категорий. Составлена тепловая карта pvalue для полей со значениями-категориями. Алгоритм визуализации заимстован у [Shafqaat Ahmad](https://medium.com/analytics-vidhya/constructing-heat-map-for-chi-square-test-of-independence-6d78aa2b140f), ([github](https://github.com/shafqaatahmad/chisquare-test-heatmap/tree/main)).
...
Манна-Уитни-U-тест был применён для выявления статистической значимости различий в распределении возрастов лиц с разными исходами попыток суицида. Для исключения возможности использования Стьюдента-Т-теста были проведены Шапиро-Уилка-тест и Колмогоров-Смирнов-тест соответствия распределений нормальному распределению. Выявлено несоответствие нормальности, исключившее возможность применения параметрических тестов. Визуально были сравнены формы распределений [[ssylka]]. Их несоответствие требует интерпретации результатов Манна-Уитни-U-теста как отражающих ситуацию стохастического доминирования значений одного распределения над значениями другого.
...
Тип данных датасета отсавил возможность построения только моделей логистической регрессии. В качестве целевого значения предсказаний использовался исход суицида.
...
Гипотеза 1. Уровень образования - прокси-значение по отношению к прожвианию человека в городе или сельской местности. Опровергается низкой важностью местности в регрессии, а также относительно невысокой разницей смертельности попыток самоубийств между городом и деревней. Хотя влияние местности невозможно исключить (ГИПОТЕЗА!!), его не следует считать решающим.

Гипотеза 2. Предыдущие наблюдения свидетельствали о росте смертельности попыток суицида с увеличением возраста. Совокупность начальных ступеней образования и высокого возраста - черта поколения, родившегося в годы индустриализации и большого скачка (1950-е - 1960-е гг). Опровергается низкой важностью возраста в регрессии, а также тем, что у возрастных групп 60-80 лет фиксируется один из наиболее высоких удельных весов образования выше начального.
...
<p align="justify"> Гипотеза 3. Неграмотность и начальное образование преимущественно фиксируется у людей до 50-60 лет. Представители этих возрастных групп родились в Китае во время или после экономических реформ 1970-х - 1980-х гг. Возможно, изменившаяся экономическая политика привела к маргинализации людей с низким образованием, неспособных конкурировать на рынке труда. Отчасти, эта гипотеза подтверждается наблюдениями в Республике Корее и Японии, где уровень образования и статус трудоустройства называется одним из основных факторов психического дистресса взрослого населения [<a style = " white-space:nowrap; " href="https://www.nature.com/articles/s41598-020-71789-y">Cheon et al, 2020</a>], [<a style = " white-space:nowrap; " href="https://www.sciencedirect.com/science/article/abs/pii/S0165032719319822">Nishi et al, 2020</a>]. Из предикторов, выявленных данными исследованиями (кроме прочего, низкий доход домохозяйства, брачный статус, независимое проживание, продолжительность сна, состояние физического здоровья, отсутствие системы психической поддержки со стороны окружающих и др.), образование является одним из единственных, имеющихся в настоящем датасете. В таком случае уровень образования можно считать прокси-значением по отношению к совокупности социально-экономических параметров, приводящих к низкому доходу домохозяйства. Наблюдение о высокой роли образоавния и благосостояния в смертельности подтверждается исследованиями [<a style = " white-space:nowrap; " href="https://www.thelancet.com/journals/lanpub/article/PIIS2468-2667(23)00207-4/fulltext">Favril et al, 2023</a>] </p> 

Естественным критическим замечанием будет тезис о том, что профессия является более информативным прокси-значением в отношении дохода. Однако поскольку датасет состоит только из людей, совершивших попытку суицида, уместно предположение о том, что подавляющая часть наблюдений уже относится к людям с низким достатком. Так, в рамках гипотезы 3 образование является предиктором дохода не для всего населения Шаньдуня, но для той его части, которая уже находится в менее благоприятном социально-экономическом положении. Тогда поле профессий, доминируемое занятостью в сельском хозйстве, не даёт возможности структурировать данную социальную группу столь эффективно, сколь значения образования, - так как уже является главной определяющей её чертой.

# Бутстрап. Логистическая модель для методов -> слишком много методов, мало наблюдений -> Бутстрап + вопрос того, делать ли группы методов равными по количеству или нет
