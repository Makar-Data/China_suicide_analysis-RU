...
Для практики вместо сводных таблиц Pandas использовались, где это возможно, таблицы SQL Server. При работе с данными преимущественно использовались вариации трёх таблиц [[s]]:
...
- Имеется тренд на стабильный рост смертельности попыток с увеличением возраста [[s]]
