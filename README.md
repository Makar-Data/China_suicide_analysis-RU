...
Для EDA преимуществественно применялись вариации трёх таблиц [[4]](https://github.com/Makar-Data/China_suicide_analysis-RU/tree/main/SQL_EDA):
...
- Датасет состоит прежде всего из наблюдений в сельской местности (2213, 86.08%) [[8]] с соответственно большой долей людей, занятых сельскохозяйственными работами (79.04%) [[9]]
- Наблюдения разделились примерно равномерно в соответствии с иходом попытки суицида (51.15% - выжили, 48.85% - умерли) [[10]]
- Видны сезонные флуктуации случаев. Во 2-м квартале фиксируется максимум, в 4-м - минимум [[11]]
- Все выжившие поытку суицида были госпитализированы. Из впоследствии умерших, госпитализировано лишь 19% [[12]]. Исход попытки - главный предиктор госпитализации
- Смертельность попыток суицида стабильно растёт с увеличением возраста [[13]]
- Наиболее распространённые методы: употребление пестицида (68.77%), повешание (16.76%), другие яды (9.84%); наименее: прыгание (0.58%), утопление (1.01%), порезы (1.13%) [[14]]
- Наиболее смертельные методы: утопление (100%) (мб из-за определения + посмотри кто топится), повешание (97%), прыгание (80%); наименее: неопределённый яд (3%), неопределённый (6%), другой яд (10%) [[15]]
